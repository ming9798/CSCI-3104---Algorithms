...
For the integer n = 16, the algorithm would fail to give the optimal solution. The algorithm would choose one 10-cent piece and three 2-cent pieces (total of 4 coins). However, the optimal solution would be to use two 8-cent pieces (total of 2 coins).
